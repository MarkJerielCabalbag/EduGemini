      ...
      {isFetching || isLoading || isPending ? (
        ...
        <div className="h-full">
          <div className="container sm:container md:container lg:container">
            <Header
              endContent={<Button onClick={() => navigate("/")}>Logout</Button>}
            />
          </div>
          <div className="container sm:container md:container lg:container">
            <div className="h-screen overflow-y-auto">
              <div className="my-5">
                ...
                <p className="italic opacity-70 text-pretty">
                  ...
                  smooth educational experience. The dashboard provides
                  real-time updates and allows for quick decision-making.
                </p>
              </div>
              <div className="my-5">
                ...
                <p className="italic opacity-70 text-pretty">
                  ...
                  participation, assignment submissions, and student
                  performance, enabling you to maintain a well-organized and
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 ">
                  ...
                  <div className=" text-slate-900 p-5 rounded-sm flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="italic opacity-70 flex items-center gap-2">
                        <XCircleIcon className="opacity-70" size={20} />{" "}
                        Declined
                      </p>
                    </div>
                  </div>
